...
# add a main title
p4 <- p3 + 
  labs(title = "Exam points compared to attitudes towards statistics")
...
library(ggplot2)
qplot(attitude, points, data = learning2014, main = "linear regression between points and attitudes") + geom_smooth(method = "lm")
